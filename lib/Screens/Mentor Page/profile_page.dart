...
import 'package:mentorup_app/Screens/Mentor Page/mentor_model.dart';
  ...
  Widget _description() {
    return Column(
      ...
      children: <Widget>[
        ...
        Center(
          child: Text(
            'I\'ve been called a thought leader and an expert. My job is leading digital strategy for a great agency called Cornett in Lexington, Ky. My experiences have given me the opportunity to flourish more and more. To serve the small business community, I offer mentorship each month. Let\'s connect!',
            style: TextStyle(
              fontWeight: FontWeight.w400,
              fontSize: 12,
              height: 1.4,
