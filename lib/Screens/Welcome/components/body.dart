...
import 'package:mentorup_app/Screens/Welcome/components/background.dart';
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            Text(
              "WELCOME TO MENTORUP",
              style: TextStyle(fontWeight: FontWeight.bold, fontStyle: FontStyle.italic,fontSize: 22, color: kPrimaryColor),
            ),
